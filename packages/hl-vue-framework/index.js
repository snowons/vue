...
function createInstanceContext(
  ...
  var Vue = instance.Vue = createVueModuleInstance(instanceId, hl);

  // DEPRECATED
  var timerAPIs = getInstanceTimer(instanceId, hl.requireModule);
...
function createVueModuleInstance(
  ...
  Vue.config.parsePlatformTagName = function (name) { return name.replace(hlRegex, ''); };
